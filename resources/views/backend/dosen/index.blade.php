...
@endif
 <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18"> Data Dosen</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2"> Data Dosen</span>
            </li>
        </ul>
    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel"
                            ...
                            <div
                                ...
                                <h4 class="fw-semibold fs-18 mb-sm-0">Data  Dosen</h4>
                                        ...
                                        <tbody>
                                            @foreach ($dosen as $item)                                                
                                                <tr class="text-center">                                               
                                                    ...
                                                    <td>
                                                        {{ $item->gelar_depan }}  {{ $item->nama_dosen }} {{ $item->gelar_belakang }}
                                                    </td>
                                                    <td>
                                                        {{ $item->email }}
                                                    </td>
