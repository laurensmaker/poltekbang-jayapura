...
@endif
 <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18"> Data Matakuliah</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2"> Data Matakuliah</span>
            </li>
        </ul>
    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel"
                            ...
                            <div
                                ...
                                <h4 class="fw-semibold fs-18 mb-sm-0">Data  Matakuliah</h4>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form id="form-delete-{{ $item->id }}"
                                                                        action="{{ route('matakuliah.destroy', $item->id) }}"
