                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="text" name="nama" class="form-control text-dark ps-5 h-58"
                                                placeholder="Nama Matakuliah" value="{{ $matkul->nama }}">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="text" name="kode_matkul" class="form-control text-dark ps-5 h-58"
                                                placeholder="Kode Matakuliah" value="{{ $matkul->kode_matkul }}">
                                            <i class="ri-user-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="text" name="jumlah_sks" class="form-control text-dark ps-5 h-58"
                                                placeholder="Jumlah SKS" value="{{ $matkul->jumlah_sks }}">
                                            <i class="ri-user-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <select name="kategori" class="form-select form-control ps-5 h-58">
                                                ...
                                                <option value="Teori"
                                                    {{ old('kategori', $matkul->kategori) == 'Teori' ? 'selected' : '' }}>
                                                    Teori
                                                </option>
                                                <option value="Praktek"
                                                    {{ old('kategori', $matkul->kategori) == 'Praktek' ? 'selected' : '' }}>
                                                    Praktek
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group position-relative">
                                            <select name="prodi" class="form-select form-control ps-5 h-58">
                                                <option value="Teknik Listrik Bandara"
                                                    {{ $matkul->prodi == 'Teknik Listrik Bandara' ? 'selected' : '' }}>
                                                    Teknik Listrik Bandara
                                                </option>
                                                <option value="Manajemen Bandar Udara"
                                                    {{ $matkul->prodi == 'Manajemen Bandar Udara' ? 'selected' : '' }}>
